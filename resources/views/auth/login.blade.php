...
<body class="flex min-h-screen items-center justify-center bg-stone-50">
    <div class="w-full max-w-sm rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
        <img src="{{ asset('images/logo-fts.webp') }}" alt="" class="h-12 w-12 rounded-lg">
        <h1 class="mt-4 text-lg font-semibold text-stone-900">FTS AI Website Admin</h1>
        <p class="mt-1 text-sm text-stone-500">Sign in to manage your AI Staff, leads and handovers.</p>
