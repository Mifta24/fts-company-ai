@php
    $staffConfig = [
        ...
        'copy' => collect($copy)->only([
            ...
            'featured', 'studio_welcome', 'voice_on', 'voice_off', 'voice_unsupported', 'nudge_general', 'nudge_services',
...
<aside id="ai-staff" class="staff-panel" data-staff-panel aria-label="{{ $staffName }} · {{ $copy['staff_role'] }}" tabindex="-1">
    ...
    <div class="staff-head staff-head-centered">
        ...
        <x-staff-character :size="132" class="staff-head-character" />
